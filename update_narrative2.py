...
start_marker = '        {/* Left: Narrative */}'
end_marker = '        {/* Right: Guard report + LLM stats */}'
start_idx = code.find(start_marker)
end_idx = code.find(end_marker)

if start_idx != -1 and end_idx != -1:
    old_left = code[start_idx:end_idx]
    new_left = '''        {/* Left: Unified Narrative Card */}
          ...
          <div className="card" style={{ padding: 0, overflow: "hidden", marginBottom: 16 }}>
            ...
            <div style={{ padding: "16px 20px", borderBottom: "1px solid var(--border)", display: "flex", justifyContent: "space-between", alignItems: "center", background: "var(--page)" }}>
              <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                <div className="avatar" style={{ fontSize: 16, width: 36, height: 36 }}>{personaInfo.avatar}</div>
                <div>
